...
!function ($)
{
    $(function()
    {
        ...
        /**
         * Posicione twipsies estáticos para a página de componentes.
         */
        if ($(".twipsies a").length)
        {
            $(window).on('load resize', function ()
            {
                ...
                {
                    $(this)
                        .tooltip({ placement: $(this).attr('title'), trigger: 'manual' })
                        .tooltip('show');
                });
            });
        }
        ...
        /**
         * Lógica de desenvolvimento javascript.
         */
        ...
        /**
         * Alternar todos os plugins de checkboxes.
         */
        ...
        /**
         * Solicitação construída em javascript.
         */
    ...
    $.ajaxTransport('jsonpi', function(opts, originalOptions, jqXHR)
    {
        ...
        return {
            ...
            send: function(_, completeCallback)
            {
                ...
                /**
                 * ... .attr('method', opts.type) ~> GET ou POST.
                 */
                form = $('<form>')
