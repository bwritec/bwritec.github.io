...
(function(window)
{
    ...
    Test.prototype = {
        ...
        setup: function()
        {
             ...
             * de teste atual. Questão: por quê ?
             */
        ...
        run: function()
        {
            ...
            } catch(e)
            {
                ...
                /**
                 * Caso contrário, o próximo teste assumirá a responsabilidade.
                 */
                saveGlobal();
        ...
        queue: function()
        {
            ...
            /**
             * Adiar quando o teste anterior for aprovado, se o
             * armazenamento estiver disponível.
             */
    ...
    var QUnit = {
        /**
         * Chame no início do teste do módulo para acrescentar
         * o nome a todos os testes.
         */
        ...
        test: function(testName, expected, callback, async)
        {
            ...
            /**
             * É o segundo argumento a testEnvironment ?
             */
        ...
        /**
         * Especifique o número de asserções esperadas para
         * garantir que o teste que falhou (nenhuma asserção
         * é executada).
         */
        ...
        /**
         * Verifica se os dois primeiros argumentos são iguais, com
         * uma mensagem opcional. Imprime valores reais e esperados.
         *
        ...
        start: function()
        {
            ...
            {
                /**
                 * Não comece até o mesmo número de stop-calls.
                 */
                return;
            }
            ...
            /**
             * Um pequeno atraso, para evitar retornos de chamada atuais.
             */
    ...
    /**
     * Compatibilidade com versões anteriores, não está
     * mais em uso.
     */
    ...
    var config = {
         ...
         * por meio do sessionStorage e pode ser alterado na UI
         * por meio da checkbox.
         */
        hidepassed: false,
    ...
    (function()
    {
        ...
        if (params[0])
        {
            for (var i = 0; i < length; i++)
            {
                ...
                /**
                 * Permitir que apenas uma chave acenda uma bandeira,
    ...
    /**
     * Defina-os após expor globais para mantê-los apenas neste
     * namespace QUnit.
     */
    extend(QUnit, {
        /**
        ...
        /**
         * Redefine a configuração do teste. Útil para testes que
         * modificam o DOM. Se o jQuery estiver disponível, use o
         * html() do jQuery, caso contrário, apenas o innerHTML.
         */
        reset: function()
        {
            if (window.jQuery)
    ...
    QUnit.load = function()
    {
        ...
        /**
         * Inicialize a configuração, salvando a fila de
         * execução.
         */
    ...
    function done()
    {
        ...
        {
            /**
             * Mostre ✖ para bom, ✔ para resultado ruim do conjunto
             * no título. Use sequências de escape caso o arquivo seja
             * carregado com conjunto de caracteres não utf-8.
             */
            document.title = [
                (config.stats.bad ? "\u2716" : "\u2714"),
    ...
    /**
     * Até agora suporta apenas Firefox, Chrome e Opera (buggy),
     * pode ser estendido no futuro para usar algo como:
    ...
    function sourceFromStacktrace()
    {
        ...
        } catch (e)
        {
            ...
            } else if (e.sourceURL)
            {
                /**
                 * Safari, PhantomJS.
                 * Questão: sourceURL aponta para a linha 'throw new Error'
                 * acima, não muito útil.
                 *
    ...
    /**
     * Retorna um novo Array com os elementos que estão em a
     * mas não em b.
     */
    function diff(a, b)
    {
    ...
    {
        /**
         * A função real equivalente.
         */
        var innerEquiv;

        /**
         * Pilha para decidir entre funções skip/abort.
         */
        var callers = [];

        /**
         * Pilha para evitar loops de referência circular.
         */
        var parents = [];

        /**
         * Chame o retorno de chamada relacionado com os argumentos
         * fornecidos.
         */
        ...
        var callbacks = function ()
        {
            ...
            function useStrictEquality(b, a)
            {
                ...
                {
                    /**
                     * Para capturar uma anotação curta VS 'nova' anotação
                     * de uma declaração. Exemplo: var i = 1;.
                     *
                     * var j = new Number(1);
                     */
                    return a == b;
            ...
            return {
                 ...
                 *
                 * initial === teria capturado referências idênticas de
                 * qualquer maneira.
                 */
                "function" : function()
                {
                ...
                "array" : function(b, a)
                {
                    ...
                    /**
                     * Referência de trilha para evitar referências
                     * circulares.
                     */
                    parents.push(a);
                ...
                "object" : function(b, a)
                {
                    ...
                    /**
                     * Construtor de pilha antes de correr em todas as
                     * propriedades.
                     */
                    ...
                    {
                        /**
                         * Seja rigoroso: não garanta hasOwnProperty e
                         * vá fundo.
                         */
                        loop = false;
    ...
    QUnit.jsDump = (function()
    {
        ...
        var jsDump = {
            ...
            /**
             * Esta é a lista de analisadores, para modificá-los, use
             * jsDump.setParser.
             */
            parsers:{
                /**
                ...
                /**
                 * Quando nenhum analisador é encontrado, isso não
                 * deveria acontecer.
                 */
                error:'[ERROR]',
                ...
                /**
                 * Objeto chama internamente, a parte principal de um
                 * item em um mapa.
                 */
                key:quote,

                /**
                 * Função chama internamente, é o conteúdo da função.
                 */
                functionCode:'[code]',
            ...
            /**
             * Atributos para despejar dos nós, name=>realName.
             */
            DOMAttrs: {
                id:'id',
                name:'name',
            ...
            /**
             * Se true, as entidades são escapadas ( <, >, \t, espaço e \n ).
             */
            HTML: false,

            /**
             * Unidade de indentação.
             */
            indentChar: '  ',

            /**
             * Se for true, os itens de uma coleção são separados
