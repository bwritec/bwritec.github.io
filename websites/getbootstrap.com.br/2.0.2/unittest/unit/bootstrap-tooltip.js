...
$(function ()
{
    ...
    test("deve adicionar o atributo data para fazer referência ao título original", function ()
    {
        ...
        equals(tooltip.attr('data-original-title'), 'Another tooltip', 'título original preservado no atributo de dados.');
    });

    /**
     *
     */
    test("deve colocar tooltips relativos à opção de posicionamento", function ()
    {
