...
$(function ()
{
    ...
    {
        ok($(document.body).collapse, 'método collapse é definido.');
    });
    ...
    test("deve mostrar um elemento collapse", function ()
    {
        ...
        ok(el.hasClass('in'), 'tem classe in.');
        ok(/height/.test(el.attr('style')), 'tem height definido.');
    });
    ...
    test("deve ocultar um elemento collapse", function ()
    {
        ...
        ok(!el.hasClass('in'), 'não tem classe in.');
        ok(/height/.test(el.attr('style')), 'tem height definido.');
    });
});
